...
{
    public class ReceiveMessagesProductionAreaChangedService
    {
        ...
        public ReceiveMessagesProductionAreaChangedService(
        ...
        public Task Handle(Message message, CancellationToken arg2)
        {
            ...
            var production = JsonConvert.DeserializeObject<Production.Contract.Production>(messageString);

            _areasService.SaveArea(production);
